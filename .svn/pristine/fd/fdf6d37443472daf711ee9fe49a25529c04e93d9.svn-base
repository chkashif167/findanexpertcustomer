                        ...
                        <div class="container">
                            <div className="offersTpBannerWrap text-center">
                                ...
                                <div class="text-center mb-3">
                                    <a href="https://pro.findanexpert.net" class="btn bg-orange text-white" target="_blank">Sign Up</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
						                ...
						                <div class="carousel-item active">
                                            ...
                                            <div class="col-md-3">
                                                <div class="sliderContentBox" id="one">
                                                    <img class="card-img-top mb-5" src={slider1} alt="slider image" />
					      		            ...
					      		            <div class="col-md-3 clearfix d-none d-md-block">
                                                <div class="sliderContentBox" id="two">
                                                    <img class="card-img-top mb-5" src={slider2} alt="Card image cap" />
						      	            ...
						      	            <div class="col-md-3 clearfix d-none d-md-block">
                                                <div class="sliderContentBox" id="three">
                                                    <img class="card-img-top mb-5" src={slider3} alt="Card image cap" />
						      	            ...
						      	            <div class="col-md-3">
                                                <div class="sliderContentBox" id="four">
                                                    <img class="card-img-top mb-5" src={slider4} alt="Card image cap" />
						                ...
						                <div class="carousel-item">
                                            ...
                                            <div class="col-md-3">
                                                <div class="sliderContentBox" id="five">
                                                    <img class="card-img-top mb-5" src={slider5} alt="slider image" />
                                            ...
                                            <div class="col-md-3 clearfix d-none d-md-block">
                                                <div class="sliderContentBox" id="six">
                                                    <img class="card-img-top mb-5" src={slider6} alt="Card image cap" />
                                            ...
                                            <div class="col-md-3 clearfix d-none d-md-block">
                                                <div class="sliderContentBox" id="seven">
                                                    <img class="card-img-top mb-5" src={slider7} alt="Card image cap" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="sliderContentBox" id="eight">
                                                    <img class="card-img-top mb-5" src={slider8} alt="Card image cap" />
                                        ...
                                        <div class="carousel-item">
                                            ...
                                            <div class="col-md-3">
                                                <div class="sliderContentBox" id="nine">
                                                    <img class="card-img-top mb-5" src={slider9} alt="slider image" />
                                            ...
                                            <div class="col-md-3 clearfix d-none d-md-block">
                                                <div class="sliderContentBox" id="ten">
                                                    <img class="card-img-top mb-5" src={slider10} alt="Card image cap" />
                                            ...
                                            <div class="col-md-3 clearfix d-none d-md-block">
                                                <div class="sliderContentBox" id="eleven">
                                                    <img class="card-img-top mb-5" src={slider11} alt="Card image cap" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="sliderContentBox" id="twelve">
                                                    <img class="card-img-top mb-5" src={slider12} alt="Card image cap" />
                                        ...
                                        <div class="carousel-item">
                                            ...
                                            <div class="col-md-3">
                                                <div class="sliderContentBox" id="thirteen">
                                                    <img class="card-img-top mb-5" src={slider13} alt="slider image" />
                                            ...
                                            <div class="col-md-3 clearfix d-none d-md-block">
                                                <div class="sliderContentBox" id="fourteen">
                                                    <img class="card-img-top mb-5" src={slider14} alt="Card image cap" />
                                            ...
                                            <div class="col-md-3 clearfix d-none d-md-block">
                                                <div class="sliderContentBox" id="fifteen">
                                                    <img class="card-img-top mb-5" src={slider15} alt="Card image cap" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="sliderContentBox" id="sixteen">
                                                    <img class="card-img-top mb-5" src={slider16} alt="Card image cap" />
                            ...
                            <div className="row">
                                <div className="col-md-12 text-center mt-4">
                                    <h1 className="font-weight-bold">We Welcome <span className="text-red">All Profesionals</span></h1>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-4 info-col pl-0">
                                    <div className="info-box section-bg-light" id="col_3">
                                        ...
                                        <a href="!#"><img className="" src={appleStore} alt="" width="auto" /></a>
                                        <a href="!#"><img className="" src={googleStore} alt="" width="auto" /></a>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                            <div className="row pb-3">
                                ...
                                <div className="col-md-4">
                                    <div className="providerOffersCards text-center">
                                        <div class="card testimonial-card">

                                            <div class="card-up indigo lighten-1"></div>
                                            <div class="avatar mx-auto white">
                                                <img src={team} class="rounded-circle" alt="card image" />
                                            </div>
