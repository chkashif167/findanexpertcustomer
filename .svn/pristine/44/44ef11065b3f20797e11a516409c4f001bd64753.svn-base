...
export class BookingPage extends Component {
        ...
        if (this.state.serviceproviderid == null) {
            if (isGeneric == 'false') {
                if (servicename == 'Massage') {
                    ...
                    //console.log(this.state.availableSlots.length);
                    ...
                    fetch(App.ApisBaseUrl + '/api/ServiceType/checkserviceprovideravailability', requestOptions)
                        ...
                        .then(response => {
                            this.setState({ checkAvailibilityResponse: response });
    ...
    handleDiscountConfirm(e) {
        ...
        fetch(App.ApisBaseUrl + '/api/Discount/getdetail?authtoken=' + localStorage.getItem('customeraccesstoken') +
            ...
            .then(data => {
                ...
                else if (this.state.hasStudentDiscount == false) {
                    toastr["error"]("You have entered an invalid code.");
                }
            });
    }
                                ...
                                .then(response => {
                                    ...
                                    return fetch(App.ApisBaseUrl + '/api/Payment/stripeholdpayments', requestOptions)
                                        ...
                                        .then(response => {
                                            ...
                                            else if (localStorage.getItem('paymentCheckOutStatus') == '400') {
    ...
    handleSubmit(e) {
        ...
        if (this.state.bookingdate != '' && this.state.bookingtime != '') {
            if (this.state.serviceproviderid == null) {
                if (isgeneric == 'true' && hasArea == 'true') {
                    if (this.state.checkAvailibilityResponse.length != 0) {
                        if (this.state.availableSlotAvailibility == false && this.state.availableSlots != null) {
                        ...
                        else if (this.state.availableSlotAvailibility == false && this.state.availableSlots == null) {

                            this.setState({ modalMessage: 'Unfortunately no service provider available at ' + localStorage.getItem('bookingdate') + '.Please choose an alternative Date &Time.', showModal: 'show' });
                        }
                        else {
                            const { customerid, serviceid, genericServicesList, bookingdate, bookingtime, duration, inhouse, inclinic, postalcode, addressid, notes } = this.state;
                            this.DoGenericBooking(customerid, serviceid, genericServicesList, bookingdate, bookingtime, duration, inhouse, inclinic, postalcode, addressid, notes);
    ...
    nonGenericServices() {
        ...
        if (inclinic == 'true' & inhouse == 'true' || inclinic == 'false' & inhouse == 'false') {
            ...
            var incliniceInhouseItems = (
                <div className="col-md-12 pt-3 inclinicInhouseMainCol">
                    <div className="col-md-12 pl-0 pr-0 inclinicInhouseCol">
        ...
        if (this.state.availableSlots != '' && this.state.availableSlots != null) {
            ...
            var dateTimeContent = (
                ...
                <div className="col-md-12 cardWrapWithShadow">
                    ...
                    <div class={"modal fade " + this.state.showModal1} id="referralModal" tabindex="-1" role="dialog" aria-labelledby="logoutModal" aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-12 text-center fs-18 p-5">
                                            {'Unfortunately no service provider available at ' + localStorage.getItem('bookingdate') + '.Please choose an alternative Date &Time.'}
                                        </div>
                    ...
                    <div className="col-md-6 pt-3">
                        <div class="form-group">
                            ...
                            <div class="">
                                <TimePicker
                                    showSecond={false}
                                    defaultValue={this.state.currentDateSlot != '' ?
        ...
        if (free_treatment_offer == 'true' || this.state.servicePrice == 0) {
                                ...
                                <div className="col-md-12">
                                    ...
                                    <form onSubmit={this.handleSubmit} className="bookingPageForm">
                                        ...
                                        <div className="row pt-4 pb-4">
                                            ...
                                            <div className="col-md-12 pt-5 dateTimeWrap bookingDateTime">
