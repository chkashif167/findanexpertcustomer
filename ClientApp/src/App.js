...
export default class App extends Component {
    ...
    static ImagesCdnUrl = 'https://1864597015.rsc.cdn77.org/images/';
    static StaticImagesUrl = 'https://1864597015.rsc.cdn77.org/images/StaticImages/';

    render() {

        var currentLocation = window.location.pathname;
        
        if (currentLocation == '/special-pages/partner-with-expert' || currentLocation == '/customer-help') {
            var layoutContent = (<SimpleLayout>
                <Route exact path='/special-pages/partner-with-expert' component={PartnerWithExpert} />
                <Route exact path='/customer-help' component={HelpMobile} />
            </SimpleLayout>);
        }
        else if (currentLocation == '/index.html' || currentLocation == '/index') {
            window.location = '/';
        }
            ...
            var layoutContent = (<Layout>
                <Switch>
                    ...
                    <Route path='/customer-authentication' component={CusomerAuthentication} />
                    ...
                    <Route path='/forgot-password-link' component={CustomerForgotPassword} />
                    ...
                    <Route path='/inbox-email-details' component={CustomerInboxEmailDetails} />
                    <Route path='/outbox-email-details' component={CustomerOutboxEmailDetails} />
                    ...
                    <Route path='/your-payment-details' component={CustomerPaymentDetails} />
                    <Route path='/payment-success-message' component={PaymentSuccessfull} />
                    <Route path='/customer-bookings' component={CustomerBookings} />
                    <Route path='/edit-customer-booking' component={EditCustomerBooking} />
                    <Route path='/your-experts' component={YourExperts} />
                    <Route path='/book-again-your-expert' component={BookAgain} />
                    <Route path='/customer-consent' component={DisplayCustomerConsent} />
                    ...
                    <Route path='/special-pages/free-beauty-treatments' component={FreeBeautyTreatment} />
                    <Route path='/special-pages/free-training' component={FreeTraining} />
