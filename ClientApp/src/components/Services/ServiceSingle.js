...
export class ServiceSingle extends Component {
        ...
        fetch(App.ApisBaseUrlV2 + '/api/ServiceType/findservicetypev2', requestOptions)
            ...
            .then(data => {
                ...
                for (var i = 0; i < this.state.allServices.length; i++) {
                    ...
                    if (this.state.allServices[i].servicetypename == this.state.servicetypename) {

                        this.setState({ categoryid: this.state.allServices[i].categoryid });
                        console.log(this.state.categoryid);
                        this.setState({ servicetypeid: this.state.allServices[i].servicetypeid });
                        this.setState({ hasfreetreatment: this.state.allServices[i].hasfreetreatment });
                        this.setState({ hasduration: this.state.allServices[i].hasduration });
    ...
    hasduration() {
        ...
        fetch(App.ApisBaseUrlV2 + '/api/ServiceType/getdurationtypedetail?servicetypeid=' + this.state.servicetypeid)
            .then(response => {
                return response.json();
            })
            .then(data => {
        ...
        fetch(App.ApisBaseUrlV2 + '/api/Booking/saveincompletebookingV2', requestOptions)
            .then(response => {
                return response.json();
            })
            .then(response => {
    ...
    isgeneric() {
        ...
        fetch(App.ApisBaseUrlV2 + '/api/ServiceType/getgenerictypedetail?servicetypeid=' + this.state.servicetypeid)
            .then(response => {
                return response.json();
            })
            .then(data => {
    ...
    hasarea() {
        ...
        fetch(App.ApisBaseUrlV2 + '/api/ServiceType/getareatypedetail?servicetypeid=' + this.state.servicetypeid)
            .then(response => {
                return response.json();
            })
            .then(data => {
    ...
    render() {
        ...
        document.getElementsByTagName("META")[5].content = 'https:' + this.state.ogUrl;
        document.getElementsByTagName("META")[6].content = 'https:' + this.state.ogImage;
        ...
        document.getElementsByTagName("META")[11].content = 'https:' + this.state.twCreator;
        document.getElementsByTagName("META")[12].content = 'https:' + this.state.twTitle;
        document.getElementsByTagName("META")[13].content = this.state.twDescription;
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="serviceTitle yes-mobile">
                                                    <h1 className="section-title m-0 m-0"><strong>{this.state.servicetypename}</strong></h1>
                                                    {obj.isfreeconsultation == false ?
                                                        <p><span class="price pr-3">From </span>£<span class="">{obj.lowestprice}</span></p>
                                                ...
                                                <div>
                                                    <div className="contentWrapper">
                                                        {(obj.offerdiscount > 0) ?
                                                            <div class="ribbon ribbonTopLeft"><span>{obj.offerdiscount}% OFF</span></div>
                                                            : ''
                                                        }
                                                        {this.state.imagepath != '' ?
                                                            <img className="img-fluid rounded" src={App.ApisImageBaseUrl + this.state.imagepath}
                                                                alt={this.state.servicetypename}></img>
                                                            : <img className="img-fluid rounded" src={placeholderLarge}
                                                                alt={this.state.servicetypename}></img>
                                                        }
                                                    </div>
                                                </div>
                                                ...
                                                <div className="serviceDetailTpRight">
                                                    <div className="no-mobile">
                                                        <div className="serviceTitle">
                                                            <h1 className="section-title m-0"><strong>{this.state.servicetypename}</strong></h1>
                                                            {obj.isfreeconsultation == false ?
                                                                <p><span class="price pr-3">From </span>£<span class="">{obj.lowestprice}</span></p>
                                                                : <p>Free Consultation</p>
                                                            }
                                                    ...
                                                    <div className="buttonWrap">
                                                        <div className="bookNow">
                                                            ...
                                                            {localStorage.getItem('isprofilecompleted') == 'false' ?
                                                                <button class="btn bg-orange text-white services-card-footer-btn" onClick={this.getNotification}>
                                                                    Book Now
                                                                </button>
                                                                : obj.isfreeconsultation == true ?
                                                                    this.state.hasduration == true ?
                                                                        <div>
                                                                            <a href={'/service-durations/?' + btoa(encodeURIComponent('serviceType=hasduration' + '&categoryid=' + this.state.categoryid + '&servicetypename=' +
                                                                                this.state.servicetypename + '&servicetypeid=' + this.state.servicetypeid +
                                                                                '&inhouse=' + obj.inhouse + '&inclinic=' + obj.inclinic + '&hasquestions=' + obj.hasquestions + '&hassession=' + obj.hassession
                                                                                + '&requiredgenderpreference=' + obj.requiredgenderpreference))}
                                                                                class="btn bg-orange text-white services-card-footer-btn">Book Now</a>
                                                                            <a href={'/service-durations/?' + btoa(encodeURIComponent('serviceType=hasduration' + '&categoryid=' + this.state.categoryid + '&servicetypename=' +
                                                                                this.state.servicetypename + '&servicetypeid=' + this.state.servicetypeid +
                                                                                '&inhouse=' + obj.inhouse + '&inclinic=' + obj.inclinic + '&isfreeconsultation=' + obj.isfreeconsultation
                                                                                + '&requiredgenderpreference=' + obj.requiredgenderpreference))}
                                                                                class="btn bg-transparent text-white services-card-footer-btn">Free Consultation</a>
                                                                        </div>
                                                                        : this.state.isgeneric == true ?
                                                                            <div>
                                                                                <a href={'/generic-booking/?' + btoa(encodeURIComponent('serviceType=isgeneric' + '&categoryid=' + this.state.categoryid + '&servicetypename=' +
                                                                                    this.state.servicetypename + '&servicetypeid=' + this.state.servicetypeid + '&hasfreetreatment=' +
                                                                                    this.state.hasfreetreatment + '&inhouse=' + obj.inhouse + '&inclinic=' + obj.inclinic +
                                                                                    '&hasquestions=' + obj.hasquestions + '&hassession=' + obj.hassession + '&inclinicprice=' + obj.inclinicprice +
                                                                                    '&inhouseprice=' + obj.inhouseprice + '&requiredgenderpreference=' + obj.requiredgenderpreference))}
                                                                                    class="btn bg-orange text-white services-card-footer-btn">Book Now</a>
                                                                                <a href={'/generic-booking/?' + btoa(encodeURIComponent('serviceType=isgeneric' + '&categoryid=' + this.state.categoryid + '&servicetypename=' +
                                                                                    this.state.servicetypename + '&servicetypeid=' + this.state.servicetypeid + '&hasfreetreatment=' +
                                                                                    this.state.hasfreetreatment + '&inhouse=' + obj.inhouse + '&inclinic=' + obj.inclinic + 
                                                                                    '&isfreeconsultation=' + obj.isfreeconsultation + '&inclinicprice=' + obj.inclinicprice +
                                                                                    '&inhouseprice=' + obj.inhouseprice + '&requiredgenderpreference=' + obj.requiredgenderpreference))}
                                                                                    class="btn bg-transparent text-white services-card-footer-btn">Free Consultation</a>
                                                                            </div>
                                                                            : this.state.istraining == true ?
                                                                                <a href={'/select-course-date/?' + btoa(encodeURIComponent('serviceType=istraining' + '&categoryid=' + this.state.categoryid +
                                                                                    '&servicetypename=' + this.state.servicetypename + '&servicetypeid=' + this.state.servicetypeid))}
                                                                                    class="btn bg-orange text-white services-card-footer-btn">Book Now</a>
                                                                                : this.state.hasarea == true ?
                                                                                    <div>
                                                                                        <a href={'/service-areas/?' + btoa(encodeURIComponent('serviceType=hasarea' + '&categoryid=' + this.state.categoryid +
                                                                                            '&servicetypename=' + this.state.servicetypename + '&servicetypeid=' + this.state.servicetypeid +
                                                                                            '&inhouse=' + obj.inhouse + '&inclinic=' + obj.inclinic
                                                                                            + '&hasquestions=' + obj.hasquestions + '&hassession=' + obj.hassession
                                                                                            + '&requiredgenderpreference=' + obj.requiredgenderpreference))}
                                                                                            class="btn bg-orange text-white services-card-footer-btn">Book Now</a>
                                                                                        <a href={'/service-areas/?' + btoa(encodeURIComponent('serviceType=hasarea' + '&categoryid=' + this.state.categoryid +
                                                                                            '&servicetypename=' + this.state.servicetypename + '&servicetypeid=' + this.state.servicetypeid +
                                                                                            '&isfreeconsultation=' + obj.isfreeconsultation + '&inhouse=' + obj.inhouse +
                                                                                            '&inclinic=' + obj.inclinic + '&requiredgenderpreference=' + obj.requiredgenderpreference))}
                                                                                            class="btn bg-transparent text-white services-card-footer-btn">Free Consultation</a>
                                                                                    </div>
                                                                                    : ''
                                                                    : this.state.hasduration == true ?
                                                    ...
                                                    <div className="btmImages no-mobile">
                                                        <a href="https://play.google.com/store/apps/details?id=com.findanexpert" target="_blank">
                                                            <img src={App.StaticImagesUrl + 'googleStore.png'} alt="" /></a>
                                                        <a href="https://apps.apple.com/us/app/find-an-expert/id1468090965?ls=1" target="_blank">
                                                            <img src={App.StaticImagesUrl + 'appleStore.png'} alt="" /></a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 info-col pr-0 noMobile">
                                        <div class="info-box section-bg-light" id="col_1">
                                            <img className="img-responsive m-auto" src={App.StaticImagesUrl + 'info_1.png'} alt="expert-mobile" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 info-col pl-0">
                                        ...
                                        <div class="info-box section-bg-light no-mobile" id="col_3">
                                            <div className="content">
                                                <a href="https://apps.apple.com/us/app/find-an-expert/id1468090965?ls=1" target="_blank">
                                                    <img className="appleImage" src={App.StaticImagesUrl + 'appleStore.png'} alt="" width="100%" />
                                                </a>
                                                <a href="https://play.google.com/store/apps/details?id=com.findanexpert" target="_blank">
                                                    <img className="gooleImage" src={App.StaticImagesUrl + 'googleStore.png'} alt="" width="100%" />
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="serviceTitle yes-mobile">
                                                    ...
                                                    {obj.lowestprice > 0 ?
                                                        (obj.offerdiscount > 0) ?
                                                            <p><span class="price pr-3">From </span><span className="text-muted"><del>£{obj.lowestprice}</del></span><span class="pl-4">£{obj.lowestprice - obj.offerdiscount / 100 * obj.lowestprice}</span></p>
                                                            : <p><span class="price pr-3">From </span>£<span class="">{obj.lowestprice}</span></p>
                                                        : <p>Free Consultation</p>
                                                    }
                                                </div>
                                                <div>
                                                    ...
                                                    {this.state.imagepath != '' ?
                                                        <img className="img-fluid rounded" src={'https://admin.findanexpert.net/' + this.state.imagepath}
                                                            alt={this.state.servicetypename}></img>
                                                        : <img className="img-fluid rounded" src={placeholderLarge}
                                                            alt={this.state.servicetypename}></img>
                                                    }
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <div className="yes-mobile">
                                                    <form onSubmit={this.handleSubmit.bind(this)}>
                                                        <div className="text-center ">
                                                            <button type="submit" className="btn bg-transparent text-white" id={obj.serviceid}
                                                                onClick={this.getServiceID}>
                                                                <i class="fas fa-heart"></i> Add to watchlist
                                                                </button>
                                                        </div>
