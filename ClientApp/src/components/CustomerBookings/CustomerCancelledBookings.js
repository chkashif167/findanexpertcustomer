...
export class CustomerCancelledBookings extends Component {
    ...
    constructor(props) {
        ...
        if (localStorage.getItem("customerid") != null) {
            fetch('/api/Booking/cancelbooking?canceltoken=' + customerAccesstoken)
                .then(response => {
                    ...
                    <div className="row pb-4">
                        ...
                        <div className="col-md-12">
                            <div className="media watchlist-bx">
                                <img className="d-flex mr-3" src={bookings.serviceTypeImagePath} alt="Service image" style={styles} />
