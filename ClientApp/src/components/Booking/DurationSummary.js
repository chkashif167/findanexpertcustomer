...
export class DurationSummary extends Component {
    ...
    constructor() {
        ...
        console.log(localStorage.getItem('isfreeconsultation'));
    ...
    componentDidMount() {
        fetch(App.ApisBaseUrlV2 + '/api/Booking/getdurationbookingsummary?bookingid=' + this.state.bookingid + '&authtoken=' + this.state.authtoken)
            ...
            .then(data => {
                ...
                //        this.setState({ isReferralBonusUsed: true });
                //    }
                //    else if (this.state.summaryDetail.price > 0 && this.state.summaryDetail.price > 30) {
                //        var applyReferral = this.state.summaryDetail.price - this.state.referralbonus;
                //        this.setState({ finalPrice: applyReferral });
                //        this.setState({ isReferralBonusUsed: true });
                //    }
                //}
                ...
                //    }
                //    else {
                //        this.setState({ finalPrice: this.state.summaryDetail.price });
                //    }
                //}
            });
                                    ...
                                    <form onSubmit={this.handleSubmit.bind(this)} className="bookingPageForm">
                                        ...
                                        <div class="card bookingSummaryCard">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="r-box__item flex flex-justify">
                                                    <h4> <i class="fas fa-address-card addressFa mr=1"></i> Location</h4>
                                                    <p>
                                                ...
                                                {localStorage.getItem('requiredgenderpreference') == 'true' ?
                                                    <div class="r-box__item flex flex-justify">
                                                        <h4>  <i class="fas fa-venus-mars genderFa rm-1"></i> Gender Preference</h4>
                                                        <p>
                                                ...
                                                {this.state.summaryDetail.discountedamount > 0 ?
                                                    <div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="r-box__item flex flex-justify">
                                                                ...
                                                                <p>
                                                                    {this.state.summaryDetail.discountedamount}
                                                                    <span>
                                                ...
                                                <div class="r-box__item flex flex-justify">
                                                    <h4> <i class="fas fa-map-marker-alt mapFa mr-1"></i> {this.state.summaryDetail.address}</h4>
                                                </div>
                                        ...
                                        <div className="text-center mb-3 checkoutBtn">
                                            <button disabled={this.state.disabledbtn} className="btn btn-lg bg-orange text-white" type="submit">{this.state.hasclickedfreeconsultation == 'false' ? "Checkout" : "Confirm"}</button>
                                        </div>
